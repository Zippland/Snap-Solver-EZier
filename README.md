...
Snap-Solver 是一个智能题目解答工具，只需按下快捷键截图，即可自动识别题目内容并给出详细解答。支持部署在局域网中，让多个设备都能便捷使用。支持使用 GPT-4o 或 Claude 3.5 来识图解题。
...
- 🎯 **一键截图**：使用快捷键（可自定义）即可截取屏幕任意区域
- 🔍 **智能识图**：使用 GPT-4o 或 Claude 3.5 识别文字
- 🤖 **AI 解答**：使用选定的 AI 引擎深度解析题目
- 🌐 **局域网共享**：一处部署，多处使用，支持家庭/教室场景
- 🔐 **代理支持**：内置代理配置，支持通过代理访问 API
